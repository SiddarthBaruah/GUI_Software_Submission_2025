	...
	def page(d,x):
		...
		with col2:
			...
			if f"{st.session_state[f"weather_description{x}"]}" == "Rainy":
				...
				st.markdown("<span style ='color:red'>**Suggested Speed:** Dues to very low temperature of about {st.session_state[f'temperature{x}']} we recommend you lower you speed to about 600 km/h</span>",unsafe_allow_html = True)
